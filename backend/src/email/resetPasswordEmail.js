        ...
        <table class="main" width="100%">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>We received a request to reset your password for your Aromatic Heaven account. Don't worry, it happens to the best of us! Click the button below to set a new password and get back to your journey of relaxation.</p>
            ...
            <tr>
                <td>
                    <div class="security-note">
                        <strong>Security Note:</strong> This link will expire in 10 minutes. If you did not request a password reset, please ignore this email or contact us immediately. Your account remains secure.
                    </div>
                </td>
            </tr>
